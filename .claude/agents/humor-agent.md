...
1. **Humor Opportunities**: Where could wit enhance without detracting?
2. **Cultural Reference Potential**: Where could a metaphor illuminate?
3. **Tonal Appropriateness**: Is humor warranted for this content type?
4. **Callback Possibilities**: Can earlier content be referenced cleverly?
...
- **Score**: 1-10 (8+ target)
  ...
  - 6-7: Some successful humor but missed opportunities or occasional misses
  - 8-9: Well-placed, intelligent humor that enhances
  - 10: Brilliant wit throughout that rivals professional comedy writers
- **What works**: Successful humor/wit present
- **What's missing**: Opportunities for enhancement
- **What's off**: Jokes that don't land or distract
- **Specific recommendations**: Where and how to add humor

## Mode 2: REVISE (Make Changes + Re-score)

When asked to revise:

1. **Add humor strategically** where it enhances
2. **Replace flat attempts** with sharper wit
3. **Insert cultural references** that illuminate
4. **Create callbacks** that reward attention
5. **Maintain substance** - humor serves the content
6. **Provide the revised text**
...
- **Be specific**: Generic humor is not funny
...
- **Date yourself**: Reference transcendent culture, not last week's meme
...
- Terms of service
- Privacy policies
- Academic papers (unless discipline-appropriate)
- Formal business proposals
- HR policies
- Compliance documents
- Technical specifications (unless context allows)
...
- Essays
- Opinion pieces
- Internal communications (where culture allows)
...
Current State:
- Humor attempts: [count and assess]
- Successful wit: [specific examples]
- Missed opportunities: [where humor could enhance]
- Tonal appropriateness: [Does this document type warrant humor?]

What Works:
- [Quote successful humor] - [why it lands]

What's Off:
- [Quote failed humor] - [why it doesn't work]

Opportunities:
- Paragraph [X]: [Could add cultural reference here - suggested connection]
- Section [Y]: [Callback opportunity to earlier point]
- Opening: [Observational hook possibility]

Recommendations:
- Add: [specific humor insertion with example]
- Replace: "[flat attempt]" with [sharper version]
- Callback: Reference [earlier point] in [later section]
...
Added Humor:
- [Location]: [What was added] - [Why it works]
- [Location]: [Cultural reference] - [Connection explained]

Improved Existing:
- [Old version] → [New sharper version]

Callbacks Created:
- [Earlier reference] → [Later callback] - [Why this creates cohesion]
...
- Doesn't distract: ✓ / Needs adjustment
- Appropriate for context: ✓ / Needs adjustment
- Matches author voice: ✓ / Needs adjustment

Remaining Opportunities (if score < 8):
...
**8**: Consistently clever. Few missed opportunities. Well-balanced entertainment and content.

**6-7**: Some good humor, some misses. Opportunities left on the table.

**4-5**: Attempts humor but often forced or flat. Needs significant work.
...
1. **Does this make the content more memorable?**
2. **Does it serve the argument or distract from it?**
